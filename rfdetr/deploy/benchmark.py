...
class TRTInference(object):
    ...
    def build_engine(self, onnx_file_path, engine_file_path, max_batch_size=32):
        ...
        with trt.Builder(self.logger) as builder,            builder.create_network(EXPLICIT_BATCH) as network,            trt.OnnxParser(network, self.logger) as parser,            builder.create_builder_config() as config:
