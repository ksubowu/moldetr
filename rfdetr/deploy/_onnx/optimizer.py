...
class OnnxOptimizer():
    ...
    def insert_groupnorm_plugin(self):
        nGroupNormPlugin = 0
        for node in self.graph.nodes:
            if node.op == "Reshape" and node.outputs != [] and                node.o().op == "ReduceMean" and node.o(1).op == "Sub" and node.o().o() == node.o(1) and                node.o().o().o().o().o().o().o().o().o().o().o().op == "Mul" and                node.o().o().o().o().o().o().o().o().o().o().o().o().op == "Add" and                len(node.o().o().o().o().o().o().o().o().inputs[1].values.shape) == 3:
                ...
                if betaNode.o().op == "Sigmoid":  
                    bSwish = True
                    lastNode = betaNode.o().o()  
                else:
                    bSwish = False
                    lastNode = betaNode  
    ...
    def insert_layernorm_plugin(self):
        ...
        for node in self.graph.nodes:
            if node.op == 'ReduceMean' and                node.o().op == 'Sub' and node.o().inputs[0] == node.inputs[0] and                node.o().o(0).op =='Pow' and node.o().o(1).op =='Div' and                node.o().o(0).o().op == 'ReduceMean' and                node.o().o(0).o().o().op == 'Add' and                node.o().o(0).o().o().o().op == 'Sqrt' and                node.o().o(0).o().o().o().o().op == 'Div' and node.o().o(0).o().o().o().o() == node.o().o(1) and                node.o().o(0).o().o().o().o().o().op == 'Mul' and                node.o().o(0).o().o().o().o().o().o().op == 'Add' and                len(node.o().o(0).o().o().o().o().o().inputs[1].values.shape) == 1:
                ...
                index = [type(i) == gs.ir.tensor.Constant for i in gammaNode.inputs].index(True)
                gamma = np.array(deepcopy(gammaNode.inputs[index].values.tolist()), dtype=np.float32)
                constantGamma = gs.Constant("LayerNormGamma-" + str(nLayerNormPlugin), np.ascontiguousarray(gamma.reshape(-1)))  
                betaNode = gammaNode.o()
                index = [type(i) == gs.ir.tensor.Constant for i in betaNode.inputs].index(True)
                beta = np.array(deepcopy(betaNode.inputs[index].values.tolist()), dtype=np.float32)
    ...
    def mha_mhca_detected(self, node, mha):
        if node.op == "MatMul" and len(node.outputs) == 1 and            ((mha and len(node.inputs[0].inputs) > 0  and node.i().op == "Add") or            (not mha and len(node.inputs[0].inputs) == 0)):
            if node.o().op == 'Shape':
            ...
            if o.op == "Reshape" and                o.o().op == "Transpose" and                o.o().o().op == "Reshape" and                o.o().o().o().op == "MatMul" and                o.o().o().o().i(0).op == "Softmax" and                o.o().o().o().i(1).op == "Reshape" and                o.o().o().o().i(0).i().op == "Mul" and                o.o().o().o().i(0).i().i().op == "MatMul" and                o.o().o().o().i(0).i().i().i(0).op == "Reshape" and                o.o().o().o().i(0).i().i().i(1).op == "Transpose" and                o.o().o().o().i(0).i().i().i(1).i().op == "Reshape" and                o.o().o().o().i(0).i().i().i(1).i().i().op == "Transpose" and                o.o().o().o().i(0).i().i().i(1).i().i().i().op == "Reshape" and                o.o().o().o().i(0).i().i().i(1).i().i().i().i().op == "MatMul" and                node.name != o.o().o().o().i(0).i().i().i(1).i().i().i().i().name:
    ...
    def fuse_kv_insert_fmhca(self, heads, mhca_index, sm):
        ...
        for idx, _ in enumerate(nodes):
            if idx + 1 > len(nodes) or idx + 2 > len(nodes):
                continue
            detected, num_dynamic_q, num_dynamic_kv, node_q, node_k, node_v, final_tranpose =                self.mha_mhca_detected(nodes[idx], mha=False)
            if detected:
    ...
    def fuse_qkv_insert_fmha(self, heads, mha_index):
        ...
        for idx, _ in enumerate(nodes):
            if idx + 1 > len(nodes) or idx + 2 > len(nodes):
                continue
            detected, num_dynamic_q, num_dynamic_kv, node_q, node_k, node_v, final_tranpose =                self.mha_mhca_detected(nodes[idx], mha=True)
            if detected:
